...
<xsd:schema xmlns:xsd="http://www.w3.org/2001/XMLSchema">
  ...
  <xsd:simpleType name="product-number-type">
    <xsd:restriction base="xsd:string">
      <xsd:pattern value="[A-Z]{2}-[0-9A-Z][0-9]{2}[0-9A-Z](-([0-9]{2}|[BLMRSX]))?" />
    </xsd:restriction>
  </xsd:simpleType>
  ...
  <xsd:simpleType name="unit-of-measure-type">
    <xsd:list itemType="normalizedString" />
  </xsd:simpleType>
...
DECLARE @x XML (dbo.ComplexBOMSchema_UserTypes);
...
DROP XML SCHEMA COLLECTION dbo.ComplexBOMSchema_UserTypes;
